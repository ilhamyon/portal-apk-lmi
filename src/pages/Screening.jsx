import { Button, Dropdown, Menu, Modal, Radio, Select, message } from "antd"
import { Link, useNavigate } from "react-router-dom"
import { useEffect, useState } from "react";
import { sanityClient } from "../lib/sanity/getClient";
import { deauthUser, isAuthenticated } from "../utils/auth";
import BeresikoRendah from "../components/BeresikoRendah";
import BeresikoSedang from "../components/BeresikoSedang";
import BeresikoTinggi from "../components/BeresikoTinggi";
...
function Screening() {
  ...
  async function fetchSanityData() {
    try {
      ...
      const filteredData = sanityData.filter(item => item.user?._ref === relawanApk_id);
  ...
  const createScreening = async (relawanApk_userData) => {
          ...
          mutations: [
            {
              create: {
                ...
                user: {
                  _type: 'reference',
                  _ref: relawanApk_id // Assuming relawanApk_userData.userId contains the ID of the user document
                },
                question1: relawanApk_userData.question1,
                question2: relawanApk_userData.question2,
                question3: relawanApk_userData.question3,
                question4: relawanApk_userData.question4,
                question5: relawanApk_userData.question5,
                question6: relawanApk_userData.question6,
                question7: relawanApk_userData.question7,
                question8: relawanApk_userData.question8,
              },
            },
          ],
        }),
      ...
      {serverData.data.length === 0 ? null :
        <section className="text-gray-900 py-10">
          ...
          <div className="flex justify-center py-10 mt-10">
            {(conclusion === "Tidak Beresiko" || conclusion === "Ringan") &&
              <>
            ...
            {(conclusion === "Tinggi" || conclusion === "Berat") &&
              <>
                <div className="flex flex-col justify-center">
                  <BeresikoTinggi />
                  <div className="flex justify-center gap-6 mt-14">
