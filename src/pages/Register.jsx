...
const createSanityUser = async (relawanApk_userData) => {
    ...
    const response = await fetch(`https://ln9ujpru.api.sanity.io/v2021-03-25/data/mutate/production`, {
      ...
      body: JSON.stringify({
        mutations: [
          {
            create: {
              _type: 'user-relawan-pemasangan-apk', // Ganti dengan jenis dokumen pengguna di Sanity Anda
              name: relawanApk_userData.name,
              email: relawanApk_userData.email,
              password: relawanApk_userData.password,
              type: relawanApk_userData.type,
            },
          },
        ],
      }),
